...
:platform-aware:compileOtherJarOtherJava
:platform-aware:createOtherJar
:platform-aware:otherJar
...
> Cannot find a compatible binary for library 'other' (Java SE 6). Available platforms: [Java SE 7]
...
...
:customvariants:compileOtherFreeJarOtherJava
:customvariants:createOtherFreeJar
:customvariants:otherFreeJar
...
> Cannot find a compatible binary for library 'other' (Java SE 8).
